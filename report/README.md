...
This folder contains the final project report and generated visualisations.
...
| `task4_knn_metrics.png` | KNN performance across scalers & distance metrics |
| `task5_pipeline.png` | Cross-validation ROC-AUC bar chart |
| `task6_extraction.png` | Extracted feature importances |
| `task7_construction.png` | Constructed feature stats |
